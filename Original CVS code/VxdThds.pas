...
var
  sMsgErrorLoadingVXDFile : PChar;
  sMsgCouldNotAccessDeviceDriver : PChar;
...
begin
  ...
  begin
    MessageBox(0, sMsgErrorLoadingVXDFile, PChar(sMsgError), mb_IconExclamation + mb_ok);
    Terminate;
    exit;
  end;
...
begin
  ...
  begin
    ...
    begin
      MessageBox(0,sMsgCouldNotAccessDeviceDriver, PChar(sMsgError), mb_IconExclamation + mb_ok);
      Terminate;
      exit;
    end;
